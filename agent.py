...
#Issue: "Client raising complain that PRS not received by them for a transaction no '99987766ERT'"
#Cause: EPRD is not received for the < trxn no >
# "72251AVVFDD" - pending and "99987766ERT" - Sent
#"Client is requesting for user details data for client_id = 125678945"
#"Client is requesting for transaction details data for client_id = 125678945"
